...
[hurst logx logy logy2]=estimate_hurst_exponent(data);
subplot(1,2,2);
plot(logx,logy,'.', logx, logy2, '-');
hold on;
...
function [hurst logx logy logy2] = estimate_hurst_exponent(data0)   % data set
